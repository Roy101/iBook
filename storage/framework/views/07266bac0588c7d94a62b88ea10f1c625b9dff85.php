...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body {
                background-image: url(frontend/slider_images/book-pump.png) !important;
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<center><h1 style="font-size: 2em; color: rgb(216, 90, 111)"><b>Login to your<br>Admin Account</h1></center>
					<form class="form-horizontal" action="<?php echo e(url('/admin_dashboard')); ?>" method="post">
                        ...
                        <fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="admin_email" type="text" placeholder="type your email"/>
							</div>
...
<?php /**PATH F:\xampp\htdocs\iBook\resources\views/admin_login.blade.php ENDPATH**/ ?>