...
<body>
                        ...
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="col-sm-6">
                                        <h1><span>i</span>Book</h1>
                                        <h2>Fast and 100% Trustworthy!</h2>
                                        <p>Get your book supply from our widest range... faster and safer, anywhere and aytime!</p>
                                        <button type="button" class="btn btn-default get">Get it now</button>
                                    </div>
                                    <div class="col-sm-6">
                                        <img  src="<?php echo e(asset('frontend/slider_images/slider_1.png')); ?>" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-6">
                                        <img  src="<?php echo e(asset('frontend/slider_images/slider_7.png')); ?>" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                        <img src="images/home/pricing.png"  class="pricing" alt="" />
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="col-sm-6">
                                        <h1><span>i</span>Book</h1>
                                        <h2>Best Brands, Best Quality!</h2>
                                        <p>Get your book supply from our widest range... faster and safer, anywhere and aytime!</p>
                                        <button type="button" class="btn btn-default get">Get it now</button>
                                    </div>
                                    <div class="col-sm-6">
                                        <img  src="<?php echo e(asset('frontend/slider_images/slider_10.png')); ?>" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                        <img src="images/home/pricing.png"  class="pricing" alt="" />
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <h1><span>i</span>Book</h1>
                                        <h2>Widest Range of Books!</h2>
                                        <p>Get your book supply from our widest range... faster and safer, anywhere and aytime!</p>
                                        <button type="button" class="btn btn-default get">Get it now</button>
                                    </div>
                                    <div class="col-sm-6">
                                        <img  src="<?php echo e(asset('frontend/slider_images/slider_3.png')); ?>" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                        <img src="images/home/pricing.png" class="pricing" alt="" />
                                    </div>
                                </div>
	...
	<section>
		...
		<div class="price-range"><!--price-range-->
						...
						<div class="text-center shipping"><!--shipping-->
...
<?php /**PATH F:\xampp\htdocs\iBook\resources\views/welcome.blade.php ENDPATH**/ ?>