        ...
        <div class="container col-sm-12">
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                  ...
                  <li><a href="<?php echo e(URL::to('/show_cart')); ?>">Shopping Cart</a></li>
            ...
            <div class="row">
                <div class="clearfix col-sm-12">
                    <div class="bill-to">
                        ...
                        <div class="form-one">
                            <form method="post" action="<?php echo e(URL::to('/save_shipping_details')); ?>">
...
<?php /**PATH F:\xampp\htdocs\iBook\resources\views/pages/checkout.blade.php ENDPATH**/ ?>