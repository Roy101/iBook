							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="text-center productinfo">
											<img src="<?php echo e(URL::to($v_product_by_category->product_image)); ?>" style="width:150px; height: auto" alt="iBook Image" />
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\iBook\resources\views/pages/category_wise_product.blade.php ENDPATH**/ ?>