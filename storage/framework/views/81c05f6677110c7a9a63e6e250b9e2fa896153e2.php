...
<head>
	...
	<link href="<?php echo e(asset('http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&amp;subset=latin,cyrillic-ext,latin-ext')); ?>" rel='stylesheet' type='text/css'>
	<!-- end: CSS -->
	...
	<!--[if lt IE 9]>
		...
		<link id="ie-style" href="<?php echo e(asset('backend/css/ie.css')); ?>" rel="stylesheet">
	<![endif]-->

	<!--[if IE 9]>
		<link id="ie9style" href="<?php echo e(asset('backend/css/ie9.css')); ?>" rel="stylesheet">
	<![endif]-->
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner" style="background-color: rgb(255, 255, 255)">
			<div class="container-fluid">
				<h1><a class="brand" href=<?php echo e(URL::to('/')); ?>><img src="<?php echo e(asset('frontend/images/book icon.png')); ?>" style="width: 50px; height:50px" alt="">
                   iBook</h1>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="<?php echo e(asset('img/avatar4.jpg')); ?>" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/all_category')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet">All Categories</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/add_category')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Category</span></a></li>
							</ul>
						</li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/all_brand')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet">All Brands</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/add_brand')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Brand</span></a></li>
							</ul>
						</li>
							...
							<ul>
								<li><a class="submenu" href="<?php echo e(URL::to('/all_product')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet">All Products</span></a></li>
								<li><a class="submenu" href="<?php echo e(URL::to('/add_product')); ?>"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Product</span></a></li>
							</ul>
						</li>

                        <li><a href="<?php echo e(URL::to('/manage_order')); ?>"><i class="icon-font"></i><span class="hidden-tablet">manage Order</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copyiBook <script>document.write(new Date().getFullYear())</script> <a href="http://index.php/"></a></span>
		</p>
	...
	<script src="<?php echo e(asset('bootbox.min.js')); ?>"></script>
...
<?php /**PATH F:\xampp\htdocs\iBook\resources\views/admin_layout.blade.php ENDPATH**/ ?>