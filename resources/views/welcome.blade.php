                        ...
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    ...
                                    <div class="col-sm-6">
                                        <img  src="{{asset('frontend/slider_images/slider_1.png')}}" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-6">
                                        <img  src="{{asset('frontend/slider_images/slider_7.png')}}" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                        <img src="images/home/pricing.png"  class="pricing" alt="" />
                                    </div>
                                </div>
                                <div class="item">
                                    ...
                                    <div class="col-sm-6">
                                        <img  src="{{asset('frontend/slider_images/slider_10.png')}}" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                        <img src="images/home/pricing.png"  class="pricing" alt="" />
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    ...
                                    <div class="col-sm-6">
                                        <img  src="{{asset('frontend/slider_images/slider_3.png')}}" style="width: 500px; height 500px" class="girl img-responsive" alt="" />
                                        <img src="images/home/pricing.png" class="pricing" alt="" />
                                    </div>
                                </div>
					...
					<div class="left-sidebar">
						...
						<?php $all_published_brand = DB::table('tbl_brand')
							...
							foreach($all_published_brand as $v_brand){?>
                                <li><a href={{URL::to('/product_by_brand/'.$v_brand -> brand_id) }}>{{$v_brand -> brand_name}}<span class="pull-right"></span></a></li>
							<?php } ?>
								</ul>
							</div>
						</div>
